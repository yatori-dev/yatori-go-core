...
func (course *XueXiTCourse) ToString() string {
	return fmt.Sprintf(
		"XueXiTCourse{Cpi: %d, Key: %v, CourseID: %s,Teacher: %s, CourseName: %s, CourseImage: %s\nCourseDataID: %d, ContentID: %d}",
		course.Cpi, course.Key, course.CourseID, course.CourseTeacher, course.CourseName, course.CourseImage, course.CourseDataID, course.ContentID,
	)
}
