...
const { nodeLength, nodeRoot } = require("jsdom/lib/jsdom/living/helpers/node");
...
const { setBoundaryPointStart, setBoundaryPointEnd } = require("jsdom/lib/jsdom/living/range/Range-impl");
