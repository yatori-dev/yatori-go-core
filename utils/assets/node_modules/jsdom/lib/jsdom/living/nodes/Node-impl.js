...
const { setAnExistingAttributeValue } = require("jsdom/lib/jsdom/living/attributes");
...
const { queueTreeMutationRecord } = require("jsdom/lib/jsdom/living/helpers/mutation-observers");
const { enqueueCECallbackReaction, tryUpgradeElement } = require("jsdom/lib/jsdom/living/helpers/custom-elements");
const {
...
const { invalidateStyleCache } = require("jsdom/lib/jsdom/living/helpers/style-rules");
