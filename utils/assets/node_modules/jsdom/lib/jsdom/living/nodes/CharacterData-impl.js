...
const { TEXT_NODE } = require("jsdom/lib/jsdom/living/node-type");
const { MUTATION_TYPE, queueMutationRecord } = require("jsdom/lib/jsdom/living/helpers/mutation-observers");
