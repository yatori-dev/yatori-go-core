...
const { getSpecifiedColor, getComputedOrUsedColor } = require("jsdom/lib/jsdom/living/helpers/colors");
const { asciiLowercase } = require("jsdom/lib/jsdom/living/helpers/strings");
const { deprecatedAliases, systemColors } = require("jsdom/lib/jsdom/living/helpers/system-colors");
